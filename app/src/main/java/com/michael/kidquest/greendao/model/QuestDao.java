...
public class QuestDao extends AbstractDao<Quest, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Confirmed = new Property(4, boolean.class, "confirmed", false, "CONFIRMED");
        public final static Property DifficultyLevel = new Property(5, String.class, "difficultyLevel", false, "DIFFICULTY_LEVEL");
        public final static Property DateAdded = new Property(6, java.util.Date.class, "dateAdded", false, "DATE_ADDED");
        public final static Property ExpiryDate = new Property(7, java.util.Date.class, "expiryDate", false, "EXPIRY_DATE");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"QUEST\" (" + //
                ...
                "\"CONFIRMED\" INTEGER NOT NULL ," + // 4: confirmed
                "\"DIFFICULTY_LEVEL\" TEXT NOT NULL ," + // 5: difficultyLevel
                "\"DATE_ADDED\" INTEGER NOT NULL ," + // 6: dateAdded
                "\"EXPIRY_DATE\" INTEGER);"); // 7: expiryDate
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Quest entity) {
        ...
        stmt.bindLong(5, entity.getConfirmed() ? 1L: 0L);
        stmt.bindString(6, difficultyLevelConverter.convertToDatabaseValue(entity.getDifficultyLevel()));
        stmt.bindLong(7, entity.getDateAdded().getTime());
 
        java.util.Date expiryDate = entity.getExpiryDate();
        if (expiryDate != null) {
            stmt.bindLong(8, expiryDate.getTime());
        }
    }
    ...
    public Quest readEntity(Cursor cursor, int offset) {
        Quest entity = new Quest( //
            ...
            cursor.getShort(offset + 4) != 0, // confirmed
            difficultyLevelConverter.convertToEntityProperty(cursor.getString(offset + 5)), // difficultyLevel
            new java.util.Date(cursor.getLong(offset + 6)), // dateAdded
            cursor.isNull(offset + 7) ? null : new java.util.Date(cursor.getLong(offset + 7)) // expiryDate
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Quest entity, int offset) {
        ...
        entity.setConfirmed(cursor.getShort(offset + 4) != 0);
        entity.setDifficultyLevel(difficultyLevelConverter.convertToEntityProperty(cursor.getString(offset + 5)));
        entity.setDateAdded(new java.util.Date(cursor.getLong(offset + 6)));
        entity.setExpiryDate(cursor.isNull(offset + 7) ? null : new java.util.Date(cursor.getLong(offset + 7)));
     }
