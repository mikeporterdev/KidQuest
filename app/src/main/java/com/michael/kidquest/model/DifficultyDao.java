    ...
    */
    ...
    protected void bindValues(SQLiteStatement stmt, Difficulty entity) {
        ...
        if (difficultyLevel != null) {
            stmt.bindString(2, difficultyLevelConverter.convertToDatabaseValue(difficultyLevel));
        }
    ...
    public Difficulty readEntity(Cursor cursor, int offset) {
        Difficulty entity = new Difficulty( //
            ...
            cursor.isNull(offset + 1) ? null : difficultyLevelConverter.convertToEntityProperty(cursor.getString(offset + 1)), // difficultyLevel
    ...
    public void readEntity(Cursor cursor, Difficulty entity, int offset) {
        ...
        entity.setDifficultyLevel(cursor.isNull(offset + 1) ? null : difficultyLevelConverter.convertToEntityProperty(cursor.getString(offset + 1)));
